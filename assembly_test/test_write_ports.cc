...
extern "C" void Write_x1(u64 Count, uint8_t *Data);
extern "C" void Write_x2(u64 Count, uint8_t* Data);
extern "C" void Write_x3(u64 Count, uint8_t* Data);
extern "C" void Write_x4(u64 Count, uint8_t* Data);
